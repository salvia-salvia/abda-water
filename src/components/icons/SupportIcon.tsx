...
export default function SupportIcon({ className }: { className?: string }) {
    return (
        <svg className={className} viewBox="0 0 295.239 295.239">
            <g></g>
            <g></g>
